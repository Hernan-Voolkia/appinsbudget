...
async def adminDB():
    ...
    conn = engine.connect()
    conn.execute(text('CREATE TABLE logpresupuestosV1 (id SERIAL PRIMARY KEY,timestamp TEXT DEFAULT,user TEXT DEFAULT,cliente INTEGER, clase INTEGER, marca INTEGER,
                       modelo INTEGER, siniestro TEXT DEFAULT, lateral TEXT DEFAULT, trasero TEXT DEFAULT,ltReparaPintura FLOAT DEFAULT 0, ltReponeElemento FLOAT DEFAULT 0, ltReponePintura FLOAT DEFAULT 0,
                       ltReponeManoObra FLOAT DEFAULT 0, ltReponeEspejoEle FLOAT DEFAULT 0, ltReponeEspejoMan	FLOAT DEFAULT 0, ltReponeManijaDel FLOAT DEFAULT 0, ltReponeManijaTra FLOAT DEFAULT 0, ltReponeMolduraDel FLOAT DEFAULT 0,
                       ltReponeMolduraTra FLOAT DEFAULT 0, ltReponeCristalDel	FLOAT DEFAULT 0, ltReponeCristalTra FLOAT DEFAULT 0, ltTotal FLOAT DEFAULT 0, trReparaPintura FLOAT DEFAULT 0, trReponeElemento FLOAT DEFAULT 0,
                       trReponePintura FLOAT DEFAULT 0, trReponeManoObra FLOAT DEFAULT 0, trReponeMoldura FLOAT DEFAULT 0, trReponeFaroExt FLOAT DEFAULT 0, trReponeFaroInt FLOAT DEFAULT 0, trTotal FLOAT DEFAULT 0,
                       Asegurado FLOAT DEFAULT 0, Tercero FLOAT DEFAULT 0, MObra FLOAT DEFAULT 0, Pintura FLOAT DEFAULT 0, Ajuste FLOAT DEFAULT 0)'))
    conn.commit()
    conn.close()
    engine.dispose()
